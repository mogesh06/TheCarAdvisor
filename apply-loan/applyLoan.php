...
<b style="color:green">Thank you for choosing our loan services. We have successfully received your loan application, and we’re excited to support you with your financial needs.</b><br>
Here are the details of your loan application:<br>
<table style ="border: 1px solid black; border-collapse: collapse">
  <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Name:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $name . '</i></td>
  </tr>
    <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Vehicle Number:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $vno . '</i></td>
  </tr>
    <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Vehicle Name:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $vname . '</i></td>
  </tr>
    <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Loan Amount:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $loanamt . '</i></td>
  </tr>
    <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Interest Rate:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $intrate . '%</i></td>
  </tr>
    <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Tenure:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $tenure . ' months</i></td>
  </tr>
    <tr style ="border: 1px solid black; border-collapse: collapse">
    <th style="font-size: 19px; border: 1px solid black; border-collapse: collapse; padding: 8px;">Date of Agreement:</th>
    <td style ="font-size: 17px; border: 1px solid black; border-collapse: collapse; padding: 8px;"><i>' . $dateagree . '</i></td>
  </tr>
</table>

Please note that your <b>FIRST INSTALLMENT is due on  </b>.<br>
