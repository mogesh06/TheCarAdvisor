...
<body>
                        ...
                        try {
                            ...
                            <table style="border: 1px solid black; border-collapse: collapse;">
                              <tr style="border: 1px solid black;">
                                ...
                                <td style="font-size: 17px; border: 1px solid black; padding: 8px;"><i>' . $vno . '</i></td>
                              </tr>
                              <tr style="border: 1px solid black;">
                                <th style="font-size: 19px; border: 1px solid black; padding: 8px;">Installment Number:</th>
                                <td style="font-size: 17px; border: 1px solid black; padding: 8px;"><i>' . $instno . '</i></td>
                              </tr>
                              <tr style="border: 1px solid black;">
                                <th style="font-size: 19px; border: 1px solid black; padding: 8px;">Amount Received:</th>
                                <td style="font-size: 17px; border: 1px solid black; padding: 8px;"><i>₹' . $dueamt . '</i></td>
                              </tr>
                              <tr style="border: 1px solid black;">
                                <th style="font-size: 19px; border: 1px solid black; padding: 8px;">Received Date:</th>
                                <td style="font-size: 17px; border: 1px solid black; padding: 8px;"><i>' . $recdate . '</i></td>
                              </tr>
                            </table><br>
  ...
  margin-right: auto;display: block;"></a></p>
            ...
            <form action="" method="post">
                ...
                <div class="field">
                    <input style="background-color: #5527c7; height:35px; border: 0; border-radius: 10px; 
                    font-weight: bold; color: #fff; font-size: 15px; cursor: pointer; transition: all .3s; 
                    margin-top: 10px; padding: 0px 10px; width: 100%;"
                        type="submit" class="btns" name="submit" value="Submit" required>
                </div>
            </form>
            ...
            <?php if ($successMessage): ?>
                <div class='message'>
                    ...
                    <a href='http://localhost:8080/thecaradvisor/loan-main.php'><button class='btn'>Go Back</button>";
                </div>
            <?php endif; ?>
